...
//         At footor
         ...
         f.setLocation(200,50);//use to set the location of frame
...
//          all these functions help to repaint or recall the server function again
    ...
    public static void main(String[] args){
        ...
        try{
            //server start at port number 6000
            ServerSocket skt=new ServerSocket(6000);
            while(true){
                //accept and send msges  from server infinitely
                Socket s=skt.accept();//it stores msg and details of socket from which msg has come
